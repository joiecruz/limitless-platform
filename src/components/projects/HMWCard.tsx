...
export default function HMWCard({ text, stars, avatar }: HMWCardProps) {
  return (
    <div className="bg-white border border-[#E5E7EB] rounded-[3px] p-4 flex flex-col justify-between min-h-[120px] shadow-sm">
      ...
      <div className="flex items-center justify-between mt-auto">
        <button className="flex items-center gap-1 px-2 pt-1 pb-2 border border-[#E5E7EB] rounded-[3px] bg-white text-[#23262F] hover:bg-[#F4F4F4] transition text-[15px] font-medium">
