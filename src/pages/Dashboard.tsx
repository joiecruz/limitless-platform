...
export default function Dashboard() {
  ...
  return (
    <>
      <SEO 
        title="Dashboard" 
        description="Access your innovation journey dashboard with Limitless Lab"
        image="https://crllgygjuqpluvdpwayi.supabase.co/storage/v1/object/public/web-assets/dashboard-preview.png"
      />
