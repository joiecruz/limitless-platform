...
-- Course enrollment counts table (read-only view essentially)
CREATE POLICY "Course enrollment counts viewable by authenticated users"
ON public.course_enrollment_counts
FOR SELECT
TO authenticated
USING (true);