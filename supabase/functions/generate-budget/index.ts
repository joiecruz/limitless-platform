...
interface BudgetPlan {
  totalBudget: string;
  categories: Array<{ category: string; description: string; amount: string; percentage: number }>;
  timeline: Array<{ period: string; amount: string; description: string }>;
  assumptions: Array<{ assumption: string; impact: string }>;
  contingencies: Array<{ item: string; amount: string; reason: string }>;
}
